...
start "Frontend (DEV)" cmd /k "cd /d %ROOT_DIR%Frontend && echo Starting Frontend (debug/reload) on http://localhost:5001 && set FLASK_DEBUG=1 && set PYTHONUNBUFFERED=1 && python app.py"
